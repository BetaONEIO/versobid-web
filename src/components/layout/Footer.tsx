        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-6 mb-4">
            ...
            <a href="#" className="text-gray-400 hover:text-pink-600 dark:hover:text-pink-400 transition-colors">
              ...
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-2.509 0-4.536-2.027-4.536-4.536s2.027-4.536 4.536-4.536 4.536 2.027 4.536 4.536-2.027 4.536-4.536 4.536zm7.119 0c-2.509 0-4.536-2.027-4.536-4.536s2.027-4.536 4.536-4.536 4.536 2.027 4.536 4.536-2.027 4.536-4.536 4.536z"/>
              </svg>
            </a>
            <a href="#" className="text-gray-400 hover:text-blue-700 dark:hover:text-blue-500 transition-colors">
