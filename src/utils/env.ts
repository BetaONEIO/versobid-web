...
const envSchema = z.object({
  VITE_SUPABASE_URL: z.string({
    required_error: 'Supabase URL is required',
    invalid_type_error: 'Supabase URL must be a string'
  }).min(1, 'Supabase URL cannot be empty'),
  VITE_SUPABASE_ANON_KEY: z.string({
    required_error: 'Supabase Anon Key is required',
    invalid_type_error: 'Supabase Anon Key must be a string'
